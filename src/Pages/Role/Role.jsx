...
const Role = () => {
  ...
  const [data, setData] = useState([
    { id: 1, name: "Bob Johnson", permission: "option1" },
    { id: 2, name: "John Doe", permission: "option2" },
                          ...
                          <tr key={user.id}>
                            ...
                            <td>
                              <select
                                ...
                                onChange={(e) => {
                                  // Update the permission in the data (this is a placeholder)
                              ...
                              >
                                ...
                                <option value="Editor">option2</option>
                                <option value="Viewer">option3</option>
                              </select>
                            </td>
                            <td>
                              <Link
